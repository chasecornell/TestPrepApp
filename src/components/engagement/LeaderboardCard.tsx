...
const TOP_PLAYERS: { name: string, level: number, xp: number }[] = [];
    ...
    <div className="card-glass border-neon-cyan/20 bg-neon-cyan/5 p-4 space-y-4">
      ...
      <div className="space-y-2">
        {TOP_PLAYERS.length === 0 ? (
          <div className="text-[10px] text-gray-500 text-center py-4 font-black uppercase tracking-widest bg-black/20 rounded-lg">
            Awaiting Global Calibration...
          </div>
        ) : (
